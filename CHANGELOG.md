...
- **Work-portfolio polish pass.** Reviewed every demo as a visitor would and tightened the rough edges so each reads like the real product it came from.
  ...
  - **A "This Site" stop.** A new final entry in the portfolio, distinct from every reconstruction: a directory of live links to the real features of this site — operator dashboard, calendar, dev thoughts, Pokémon TCG, fantasy, ZeroProof, vitals, updates, design system — each opening its actual page.
  ...
  - Covered by the work-portfolio suite, updated for the new validation, env-aware links, enriched wallet overview, and the This Site directory; the whole unit suite (3000+ tests) stays green.
