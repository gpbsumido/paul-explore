...
// Three integers, regenerated by scripts/count-tests.mjs on every build. Cheap
// enough to import anywhere, and the only honest source for a number that
// changes with every test added.
import {
  TEST_COUNT,
  UNIT_TEST_COUNT,
  E2E_TEST_COUNT,
} from "./testCount.generated";
