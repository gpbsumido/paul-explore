...
function buildFallbackBracket(season: number): PlayoffBracket {
  const matchups: PlayoffMatchup[] = [
    ...
    r1(
      ...
      { seed: 8, teamId: "14", abbreviation: "MIA", name: "Miami Heat" },
    ),
    r1(
      "E_R1_M2",
      "East",
      { seed: 2, teamId: "2", abbreviation: "BOS", name: "Boston Celtics" },
      { seed: 7, teamId: "17", abbreviation: "ORL", name: "Orlando Magic" },
    ),
    r1(
      "E_R1_M3",
      "East",
      { seed: 3, teamId: "18", abbreviation: "NYK", name: "New York Knicks" },
      {
        seed: 6,
        teamId: "25",
        abbreviation: "PHI",
    ...
    r1(
      "E_R1_M4",
      "East",
      { seed: 4, teamId: "11", abbreviation: "IND", name: "Indiana Pacers" },
      { seed: 5, teamId: "15", abbreviation: "MIL", name: "Milwaukee Bucks" },
    ),
    ...
    r1(
      ...
      { seed: 8, teamId: "29", abbreviation: "MEM", name: "Memphis Grizzlies" },
    ),
    r1(
      "W_R1_M2",
      "West",
      { seed: 2, teamId: "10", abbreviation: "HOU", name: "Houston Rockets" },
      { seed: 7, teamId: "8", abbreviation: "DAL", name: "Dallas Mavericks" },
    ),
    r1(
      "W_R1_M3",
      "West",
    ...
    r1(
      "W_R1_M4",
      "West",
      { seed: 4, teamId: "7", abbreviation: "DEN", name: "Denver Nuggets" },
      {
        seed: 5,
        teamId: "9",
        abbreviation: "GSW",
