...
export const COMPONENTS: ComponentDoc[] = [
  ...
  },
  {
    ...
    category: "effects",
    name: "Portrait Spiral Hero",
    importName: "Hero06",
    tagline: "A hero whose portraits spiral behind copy that stays in charge.",
    usage:
      "Use as a page hero. Supplied images arrange in a spiral behind slots for heading, description, actions, navigation and an optional centrepiece; missing imagery never removes the copy.",
    a11y: [
      "Set headingLevel so the heading fits the page outline; imagery is decorative with meaning kept in the copy",
      "The decorative gallery moves only a few pixels and holds still under prefers-reduced-motion",
    ],
    usedOn: [],
    elsewhere: EFFECT_ELSEWHERE,
  },
  {
    ...
    importName: "Hero13",
    tagline: "A hero that arranges its portraits with CSS perspective for depth.",
    usage:
      "Use as a page hero with more depth. The same heading, description, navigation and action slots, arranged with CSS perspective rather than a spiral.",
    a11y: [
      "Set headingLevel so the heading fits the page outline; imagery is decorative with meaning kept in the copy",
      "The decorative gallery holds still under prefers-reduced-motion",
    ],
    usedOn: [],
    elsewhere: EFFECT_ELSEWHERE,
  },
