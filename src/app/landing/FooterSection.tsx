...
export default function FooterSection() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center overflow-hidden bg-black px-6 py-32 text-center">
      ...
      <div ref={ref as RefObject<HTMLDivElement>}>
        <h2
          className={`text-4xl font-bold tracking-tight text-white md:text-5xl ${reveal(visible)}`}
        >
          Ready to explore?
        </h2>
        <p
          className={`mt-4 text-lg text-white/70 ${reveal(visible, "delay-100")}`}
        >
