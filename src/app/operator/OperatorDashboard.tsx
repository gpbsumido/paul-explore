    ...
    <main className="reveal-up mx-auto max-w-5xl px-4 sm:px-6 py-6 space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        <Link
          ...
          className="touch-min inline-flex items-center gap-1.5 rounded-lg border border-border bg-surface px-3 py-2 text-sm font-medium text-foreground transition-colors hover:border-primary-400 hover:text-primary-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 dark:hover:text-primary-400"
        >
          Search
