        ...
        {publications.map((pub) => (
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="touch-min inline-flex items-center font-medium text-foreground underline-offset-2 hover:underline"
            >
              {pub.title}
            </a>
        ...
        return (
          ...
          >
            <button
              ...
              aria-expanded={isOpen}
              aria-controls={panelId}
              className="touch-min flex w-full items-center justify-between gap-3 px-4 py-3 text-left hover:bg-surface"
            >
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  ...
                  <label className="flex shrink-0 items-center gap-2 text-sm text-muted">
                    <input
                      ...
                      className="touch-target h-4 w-4 accent-foreground"
                    />
            ...
            >
              ...
              >
                ...
                <span className="flex shrink-0 items-baseline gap-2 sm:justify-end">
                  ...
                  {inDemo !== undefined && (
                    <span className="touch-min rounded-full border border-border bg-surface px-2 py-0.5 text-xs tabular-nums text-muted">
                      {inDemo} of {recent}
                      {share !== null && ` · ${share}%`}
                    </span>
                  )}
                ...
                >
                  ...
                  >
                    ...
                    <span className="flex flex-wrap items-center gap-2">
                      <span className="touch-min rounded-full border border-border bg-surface px-2 py-0.5 text-xs text-muted">
                        {paper.design.label}
                      </span>
