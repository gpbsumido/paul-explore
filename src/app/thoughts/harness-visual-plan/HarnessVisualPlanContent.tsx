    ...
    <ThoughtLayout
      ...
      intro={
        <>
          ...
          <span className="font-medium text-foreground">visual plan</span> before
          any code exists, and a{" "}
          ...
          data model, the endpoints, the states, the open questions, and the list
          of failing tests I&rsquo;m about to write — not a wall of chat prose.
          This is the write-up on why I work that way, and what it buys me.
        </>
      }
    >
      <Section title="What it is">
        <p>
          ...
          claiming to build. Then, when it&rsquo;s all pushed, I write the mirror
        ...
        <p className="mt-3">
          ...
          changelog. Put them side by side and the plan becomes something I can be
          held to, and the recap becomes the honest record of what actually
      ...
      <Paywall>
        <div data-testid="gated-content" className="space-y-10">
          ...
          <Section title="How it actually helps">
            <p>
              The payoff shows up in a few concrete places, not as a vague feeling
              of being organized.
            </p>
            <ul className="mt-3 space-y-2">
              <Bullet>
                <span className="font-medium">Missing states surface early.</span>{" "}
              ...
              <Bullet>
                <span className="font-medium">Reuse leads.</span> Every row names a
                real file or helper before it names something new, so the plan
                describes the genuine delta instead of redescribing the system —
                and I stop reinventing things I already have.
              </Bullet>
              <Bullet>
                <span className="font-medium">The hard-to-reverse bets get
                settled up front.</span> Wire formats, public ids, the data-model
                shape, and the auth and ownership boundaries get decided in the
                plan, where changing my mind costs nothing.
              </Bullet>
              <Bullet>
                <span className="font-medium">The recap keeps me honest.</span> It
                gets built mechanically from the diff, so I can&rsquo;t quietly
                paper over the places where I deviated. If I said one thing and
                shipped another, the recap says so out loud.
              </Bullet>
            </ul>
          </Section>
          ...
          <Section title="The pros, plainly">
            <ul className="space-y-2">
              <Bullet>
                A reviewable direction <span className="font-medium">before</span>{" "}
                code exists — the earliest possible point to correct course, when
              ...
              <Bullet>
                Structured blocks beat prose. Tables, wireframes, and diagrams are
                skimmable and comparable in a way paragraphs never are.
              </Bullet>
            </ul>
          </Section>
          ...
          <Section title="And the cons, honestly">
            <ul className="space-y-2">
              <Bullet>
                ...
                ceremony, so I skip it there — the skill is gated to changes that
                touch behavior, UI, schema, or an API contract.
              </Bullet>
              <Bullet>
              ...
              <Bullet>
                There&rsquo;s a temptation to over-plan — to spec the whole feature
                when I should scope the smallest first cut that proves the
                approach and defer the rest. The discipline is knowing when to
                stop.
              </Bullet>
              <Bullet>
                Two documents can rot if I let them. The recap is what keeps the
                plan from becoming a lie, but only because I commit to writing it
                every time.
              </Bullet>
            </ul>
          </Section>
          ...
          <Section title="How I run it, step by step">
            <ol className="space-y-2 list-decimal pl-5 marker:text-muted">
              <li>
                <span className="font-medium">Research, read-only.</span> Read the
                actual files, name real paths and symbols, and figure out what to
                reuse before what to add. No source edits while planning.
              </li>
              <li>
                ...
                and endpoints, the RED test list, and any assumption written as an
                open question with the default I&rsquo;ll proceed on.
              </li>
              <li>
                <span className="font-medium">Review it in the browser</span> as a
                rendered page, so I&rsquo;m judging a real layout, not imagining
              ...
              <li>
                ...
                green.</span> When reality forces a change — it will — I don&rsquo;t
                quietly rewrite the plan to match. I leave it as the record of
                what was agreed.
              </li>
              <li>
                <span className="font-medium">Write the recap</span> once the work
                is pushed: the same blocks, filled from the real diff, with every
          ...
          <Section title="What I&rsquo;d revisit">
            <p>
              The biggest open question is where the line sits. Right now I lean on
              judgment — behavior, UI, schema, or contract changes get a plan;
              typos and doc edits don&rsquo;t — and that&rsquo;s mostly right, but
              the middle is fuzzy. The other thing I keep watching is the cost of
              the recap: it earns its keep every time a drift shows up, but on the
              runs where I nailed the plan exactly it can feel like paperwork. So
              far the honesty it buys on the messy runs is worth the tax on the
              clean ones, and that&rsquo;s the trade I&rsquo;m happy to keep
              making.
            </p>
          </Section>
        </div>
