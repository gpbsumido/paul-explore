      ...
      chat={
        <main className="mx-auto max-w-3xl px-4 py-10 sm:py-14">
          <div className={styles.chat}>
            ...
            <Sent pos="first">
              way simpler — no stories, no reels, no algorithm deciding what you
              see
            </Sent>
            ...
            <Sent pos="last">
              separate domain, own codebase, totally outside this repo
            </Sent>
    ...
    >
      <section>
        ...
        <p className="text-muted">
          ...
          captions or drop a quick text post — both land in the same feed. The
          experience is deliberately stripped back compared to Instagram: no
          stories, no reels, no algorithmic noise. Just a feed of posts from
          people you follow.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="mt-2 space-y-2 text-muted">
          <li className="flex gap-2">
            ...
            <span>
              Image posts upload a photo with an optional caption — displayed
              inline in the feed at full width
            </span>
          </li>
          <li className="flex gap-2">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-foreground/30" />
            <span>
              Text posts are just content, no photo required — sit cleanly in
              the same feed without feeling second-class
            </span>
          </li>
          <li className="flex gap-2">
            <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-foreground/30" />
            <span>
              Both types support likes and live in the same chronological feed
            </span>
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p className="text-muted">
          Ketsup is a real product meant to be used, not just a feature demo.
          Keeping it in paul-explore would have tied it to all the decisions in
          this repo — auth, deployment, bundle constraints — which didn&apos;t
          make sense for something that might have real users. Its own domain
          gives it a clean identity and room to evolve independently.
        </p>
      </section>
