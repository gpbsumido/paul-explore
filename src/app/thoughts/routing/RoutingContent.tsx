          ...
          <div className="space-y-10 text-[15px] leading-relaxed text-foreground">
            <section>
              ...
              <p className="text-muted">
                ...
                by the middleware. This meant the URL in the browser always
                reflected an implementation detail, not a meaningful
                destination. The hub at{" "}
                <code className="rounded bg-surface px-1 py-0.5 text-[13px] font-mono text-foreground">
                  /protected
                </code>{" "}
                was just an awkward artifact of how auth-gating was wired up,
              ...
              <p className="mt-3 text-muted">
                ...
                Logged-in users see the hub. Same URL, different content. Vitals
                and settings move to{" "}
                <code className="rounded bg-surface px-1 py-0.5 text-[13px] font-mono text-foreground">
                  /vitals
                </code>{" "}
                and{" "}
            ...
            <section>
              ...
              <p className="text-muted">
                ...
                middleware handled the redirect for authenticated users. No auth
                call touched the page component itself.
              </p>
              <p className="mt-3 text-muted">
              ...
              <p className="mt-3 text-muted">
                ...
                does not make a network call — it decrypts the session cookie
                locally using the{" "}
                <code className="rounded bg-surface px-1 py-0.5 text-[13px] font-mono text-foreground">
                  AUTH0_SECRET
                </code>{" "}
                key. The cost is a few microseconds of CPU work. The hub content
                is still fetched client-side via TanStack Query exactly as
                before. For a personal portfolio, clean URLs are worth more than
                static generation on the root route.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted">
                The middleware still enforces auth — it just protects different
                paths now.{" "}
                <code className="rounded bg-surface px-1 py-0.5 text-[13px] font-mono text-foreground">
                  /vitals
                </code>{" "}
              ...
              <p className="mt-3 text-muted">
                ...
                route is not middleware-gated because it intentionally renders
                for both states. There is nothing sensitive in the landing page
                for unauthenticated users and the hub content only renders after
                the server confirms a valid session. An unauthenticated request
                can never reach the hub code path.
              </p>
            </section>
              ...
              <ul className="mt-2 space-y-2 text-muted">
                ...
                <li className="flex gap-2">
                  ...
                  <span>
                    ...
                    — converted from a static export to an async server
                    component; now calls{" "}
                    <code className="rounded bg-surface px-1 py-0.5 text-[13px] font-mono text-foreground">
                      auth0.getSession()
                    </code>{" "}
            ...
            <section>
              ...
              <p className="text-muted">
                The Express backend constructs the Google Calendar OAuth
                callback URL as{" "}
                <code className="rounded bg-surface px-1 py-0.5 text-[13px] font-mono text-foreground">
                ...
                success banner won&apos;t fire after connecting Google Calendar
                — but the middleware will catch the old URL gracefully. Deploy
