...
export const FEATURES: WorkFeature[] = [
  ...
  },
  {
    ...
    explainer: {
      ...
      mocked:
        "The dnd-kit board and the edit modal are real; the seed posts are static fixture content.",
    },
  },
  {
    slug: "community-mode",
    ...
    explainer: {
      ...
      mocked:
        "Posting, replying, the live like counter, and the analytics modal are real; the underlying engagement figures are generated.",
    },
  },
  {
    ...
    explainer: {
      ...
      mocked:
        "The stepper, the enforced stat budget, and the roster are real; everything lives in local state.",
    },
  },
  // Analytics Suite
  {
    ...
    explainer: {
      ...
      stack:
        "ECharts wrapped in typed React components, one markdown doc per chart",
      mocked:
        "All 17 charts, the per-chart settings, the custom tooltip, and focus-mode paging are real, rebuilt on this site's chart stack with generated data; the originals used ECharts.",
    },
  },
  {
    ...
    explainer: {
      ...
      mocked:
        "The charts and filters are real and recompute locally; the production BI embeds are replaced with local charts.",
    },
  },
  // Driver Onboarding
  {
    ...
    explainer: {
      ...
      mocked:
        "Per-step validation and the attribution carry-through are real; submissions land in memory, not an API.",
    },
  },
  {
    ...
    explainer: {
      ...
      mocked:
        "The chart is real; the live tick is a local interval instead of a polling API.",
    },
  },
  // Portal v1
  {
    ...
    explainer: {
      ...
      mocked:
        "The compare mode and delta math are real and config-driven; titles are anonymized to Game A, B, C.",
    },
  },
  // Platform Console
  {
    ...
    explainer: {
      ...
      stack: "Next.js 15, MUI 7, Redux",
      mocked:
        "Create flows, the assignment relations, and the key reveal/copy are real and persist locally; the seed data is fixture content.",
    },
  },
  {
    ...
    explainer: {
      ...
      mocked:
        "The streaming UI, confirm gate, and voice branching are real; the copy is canned, there is no model behind it.",
    },
  },
  // Conference Game Demo
  {
    ...
    explainer: {
      ...
      mocked:
        "The loading-to-playable flow and the canvas minigame are real; the original engine build is not shipped here.",
    },
  },
  // Public Dashboards
  {
    ...
    explainer: {
      ...
      mocked:
        "The slug picker, the read-only config panel, and the distinct per-slug layouts are real; the numbers are generated locally.",
    },
  },
  // Gamer Hub
  {
    ...
    explainer: {
      ...
      stack:
        "ethers.js and a wallet-connect modal originally; rebuilt on wagmi + viem + RainbowKit",
      mocked:
        "The wallet connect and the balance/ENS reads are real; the NFT grid is fixture data and the drag transfer is a visualization, not a chain transaction.",
    },
  },
  // UA & Referrals
  {
    ...
    explainer: {
      ...
      stack: "CRA, MUI forms",
      mocked:
        "The stepped flow and the persisting live preview are real; saving is local.",
    },
  },
  {
    slug: "referral-links",
    ...
    explainer: {
      ...
      stack:
        "CRA and public routes originally; here a typed client + react-query against a portfolio_api referrals service",
      mocked:
        "Link creation and click tracking are real HTTP calls; if the service is unreachable the demo degrades gracefully instead of breaking.",
    },
  },
  {
    slug: "auth-flows",
    ...
    explainer: {
      ...
      mocked:
        "The typeable fields and validation are real; nothing actually authenticates.",
    },
  },
  // Portal v2
  {
    ...
    explainer: {
      ...
      mocked:
        "The dnd-kit grid, reorder, and resize are real; the widget contents are generated.",
    },
  },
  {
    slug: "wallet-lookup",
    ...
    explainer: {
      ...
      mocked:
        "The tabbed UI plus the loading and empty states are real; addresses resolve to fixture wallets.",
    },
  },
  {
    ...
    explainer: {
      ...
      mocked:
        "Inline block editing and local image import are real; the campaign table and audiences are fixtures.",
    },
  },
  {
    ...
    explainer: {
      ...
      mocked:
        "Node dragging, in-place config editing, and add/remove edges are real; the starting graph is fixture data.",
    },
  },
  {
    slug: "llm-assistant",
