...
describe("campaign manager demo", () => {
  it("creates a campaign from the form", () => {
    ...
    expect(screen.getByText("Holiday event")).toBeInTheDocument();
  });

  it("toggles a campaign's status", () => {
    render(<CampaignManagerDemo feature={feature} />);
    const toggle = screen.getByRole("button", { name: "Toggle Creator spotlight" });
