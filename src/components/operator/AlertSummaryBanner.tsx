      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
        {criticalCount > 0 && (
          <button
            ...
            className="touch-min inline-flex items-center rounded font-medium text-error-700 hover:text-error-800 dark:text-error-400 dark:hover:text-error-300 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
          >
        ...
        {warningCount > 0 && (
          <button
            ...
            className="touch-min inline-flex items-center rounded font-medium text-warning-700 hover:text-warning-800 dark:text-warning-400 dark:hover:text-warning-300 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
          >
