      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            onClick={onClose}
            disabled={loading}
            className="touch-min rounded-md border border-border px-3 py-1.5 text-sm font-medium text-foreground transition-colors hover:bg-surface-raised disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
          >
            Cancel
          </button>
          <button
