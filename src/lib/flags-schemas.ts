...
// ---------------------------------------------------------------------------
// Feature flag domain schemas
//
// A small but complete model of a feature-flag service: flags with typed
// variations, per-environment config (kill switch, targeting rules, and a
// weighted fallthrough rollout), plus the shapes for evaluating a flag against
// a user context. Types are derived from these schemas in types/flags.ts so the
// wire format and the compile-time types never drift.
// ---------------------------------------------------------------------------
...
/** POST body for the evaluation playground. */
