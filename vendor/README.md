...
These npm archives are built from the `codex/mobile-heroes` branch in `paul-design-system`, commit `ad4aa35` ([PR 103](https://github.com/gpbsumido/paul-design-system/pull/103)).
